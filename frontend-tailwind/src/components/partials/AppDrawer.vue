    ...
    <div id="drawer-navigation"
        ...
        <div class="py-4 overflow-y-auto">
            <ul class="space-y-2 font-medium">
                <ListItem v-for="(elem, index) in navbarLinks" :key="index" :label="elem.label" :link="elem.url" />
            </ul>
        </div>
    </div>
</template>
...
<script setup>
import { ref } from 'vue';
import ListItem from '../utils/ListItem.vue';
...
const navbarLinks = ref(props.links)
