    ...
    <div class="flex flex-row gap-5 justify-center">
        <div class="flex flex-col">
            <div class="bg-blue-tag h-12 flex items-center shadow-md">
                <span class="text-blue-cart font-semibold text-3xl ms-9">Manage Orders</span>
            </div>
                ...
                <button @click="fetchAll">
                    <div class="flex justify-end my-1">
                        ...
                        <div v-if="loading" role="status">
                            <svg aria-hidden="true" class="w-4 h-4 animate-spin text-gray-600 fill-blue-600"
...
import Table from '@/components/order/parts/OrderTable.vue';
import { useOrdersStore } from '@/stores/orderStore';
import OrderFilters from '@/components/order/parts/OrderFilters.vue'
...
const fetchAll = async () => {
    fetchedNum.value = -1
    loading.value = true;
    await store.fetchOrderData({ num: fetchedNum.value })
    loading.value = false;
}
